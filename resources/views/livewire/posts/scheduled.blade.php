...
new class extends Component {
    ...
    public function getSortBy(): string
    {
        return match ($this->sortBy) {
            'published_at' => __('Date Scheduled'),
            ...
            <flux:dropdown>
                ...
                <flux:menu>
                    <flux:menu.radio.group wire:click="setSortBy()" wire:model="sortBy">
                        <flux:menu.radio value="published_at">{{ __('Date scheduled') }}</flux:menu.radio>
    ...
    @empty
        <flux:card>
            <div class="flex flex-col items-center justify-center text-center space-y-3 w-full pt-5 pb-10">
                ...
                @else
                    <x-svgs.schedule class="h-64"/>
                    <flux:heading size="lg">{{ __('No scheduled posts') }}</flux:heading>
